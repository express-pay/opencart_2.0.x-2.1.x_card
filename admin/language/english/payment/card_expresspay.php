...
$_['text_card_expresspay']  = '<a target="_blank" href="https://express-pay.by/"><img src="view/image/payment/card_expresspay.png" alt="Express-pay Website" title="Express-pay Website"/></a>';
$_['text_edit']             = 'Change Settings';
$_['text_about']            = '«Express Payments: Bank cards» - plug-in for integration with the service «Express Payments» (express-pay.by) through the API.
<br/>plugin allows you to invoice in Bank cards system to receive and process the payment notice in the bank cards system.
...
$_['namePaymentMethodDefault']          = 'Express pay: Bank cards';
$_['tokenLabel']                        = 'Token';
